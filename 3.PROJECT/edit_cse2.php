      ...
      <div class="container " style="justify-content:center;"  >
        <div class="row">
            <div class="col-md-12">
                ...
                <form action='process_edit_cse2.php?id=<?php echo $row['id']?>' method="POST" onsubmit="return checked();"name="regform" id="regform">
                    <div class="row">
                         <div class="col-md-10">
                            <label for="">Ảnh</label>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                               ...
                               <a href="index_cse2.php" class="btn btn-primary">Reset</a>
                            </div>
                        </div>
                    </div>
