...
<html lang="en">
  ...
  <body>
      <div class="container " style="justify-content:center;"  >
        <div class="row">
            <div class="col-md-6">
                <h3 style="text-align:center;">SỬA THÔNG BÁO</h3>
                <form action='process_edit_tb.php?id=<?php echo $row['id']?>' method="POST" onsubmit="return checked();"name="regform" id="regform">
                    <div class="form-group">
                      <label for="">Sửa thông báo</label>
