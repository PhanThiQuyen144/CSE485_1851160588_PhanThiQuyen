                ...
                <div class="container  "  >
                   <div class="row ">
                        <div class="col-md-12 gthieu text-white">
                            <h5 >
                                <a href="../gioithieu/gioithieu.php" class="text-white">Giới thiệu</a> > <a href="../gioithieu/logokhoa.php" class="text-white">Logo của Khoa</a> 
                            </h5>
                        </div>
                   </div>
                        ...
                        <div class="col-md-9 logo">
                            ...
                            <?php 
                                ...
                                while($row = mysqli_fetch_assoc($result)){ ?>
                                  <div class="col-md-6 images">
                                    <img src="<?php echo $row['image'] ?>" alt=""  class="img-fluid mb-2">
                                  </div>
                                <?php 
                                }
                                ?>
                            <div class="row" style="float: right;;">
                                <div class="col-md-12" style="float: right;">
                                    <a href="../gioithieu/logokhoa.php">Trở về đầu trang</a>
                                </div>
                            </div>
                            <div class="row icon" >
