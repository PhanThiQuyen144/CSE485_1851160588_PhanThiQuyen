                           ...
                           <div class="collapse navbar-collapse" id="collapsibleNavId">
                               <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                   <li class="nav-item dropdown ">
                                        <a class="homesp navbar-brand" href="http://loclahost:81/CSE485_1851160588_PhanThiQuyen/#.PROJECT/CSE.php">TRANG CHỦ</a>
                                   </li>
                               </ul>
                           </div>
                ...
                <div class="container">
                    <div class="row ">
                        <div class="col-md-12 gthieu text-white" style="margin-bottom: 5%;">
                            <h5 >
                                <a href="gioithieu.php" class="text-white">Giới thiệu</a> > <a href="loichaomung.php" class="text-white">Lời chào mừng</a> 
                            </h5>
                        </div>
                   </div>
                    <div class="row" >
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide " data-ride="carousel" >
                                    ...
                                    <div class="carousel-inner "   >
                                        <div class="carousel-item active "  >
                                            <a href=""> <img src="../../images/khai-truong.jpg" class="d-block w-100" alt="..."></a>
                                        </div>
                                        <div class="carousel-item " >
                                            <img src="../../images/cse-tlu-nara.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item "  >
                                            <img src="../../images/cntt-fsoft-ky.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item "  >
                                            <img src="../../images/labms.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item "  >
                                        ...
                                        <div class="carousel-item ">
                                            <img src="../../images/k54-tot-nghiep.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item " >
                                            <img src="../../images/rivf.jpg" class="d-block w-100" alt="..." >
                                        </div>
                                        <div class="carousel-item"  >
                                            <img src="../../images/rivf-gala.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item "  >
                                        ...
                                        <div class="carousel-item " >
                                            <img src="../../images/hop-tac.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item " >
                                            <img src="../../images/inra1.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        ...
                                        <div class="carousel-item "  >
                                            <img src="../../images/trao-doi.jpg" class="d-block w-100" alt="...">
                                        </div>
                                        <div class="carousel-item "  >
                                            <img src="../../images/bia7-1-.jpg" class="d-block w-100" alt="...">
                                        </div>
                                    </div>
