...
<html lang="en">
  ...
  <body>
      <div class="container " style="justify-content:center;"  >
        <div class="row">
            <div class="col-md-6">
                <h3 style="text-align:center;">SỬA LOGO KHOA</h3>
                <form action='process_edit_logokhoa.php?id=<?php echo $row['id']?>' method="POST" onsubmit="return checked();"name="regform" id="regform">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                               ...
                               <a href="../../index_logokhoa.php" class="btn btn-primary">Reset</a>
                            </div>
                        </div>
                    </div>
