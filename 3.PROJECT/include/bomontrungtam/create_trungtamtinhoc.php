...
<html lang="en">
  <head>
    <title>Create Computer Center</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
      <div class="container " style="justify-content:center;"  >
        <div class="row">
            <div class="col-md-6">
                <h3 style="text-align:center;">THÊM NỘI DUNG TRUNG TÂM TIN HỌC</h3>
                <form action="process_create_trungtamtinhoc.php" method="post">
                    <div class="row">
                         <div class="col-md-4">
