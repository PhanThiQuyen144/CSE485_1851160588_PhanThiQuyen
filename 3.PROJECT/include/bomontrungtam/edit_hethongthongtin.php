<?php   
    ...
    $id=$_GET['id'];
    $sql="SELECT * FROM hethongthongtin where id=$id";
...
<html lang="en">
  <head>
    <title>Edit Information System</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
      <div class="container " style="justify-content:center;"  >
        <div class="row">
            <div class="col-md-6">
                <h3 style="text-align:center;">SỬA HỆ THỐNG THÔNG TIN</h3>
                <form action='process_edit_hethongthongtin.php?id=<?php echo $row['id']?>' method="POST" onsubmit="return checked();"name="regform" id="regform">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                               ...
                               <a href="../bomontrungtam/index_hethongthongtin.php" class="btn btn-primary">Reset</a>
                            </div>
                        </div>
                    </div>
