                    ...
                    <div class="title  ">
                       <nav class="navbar navbar-expand-sm navbar-light navbar1" style=" padding: 0px !important;" >
                           ...
                           <div class="collapse navbar-collapse" id="collapsibleNavId">
                               <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                    <li class="nav-item dropdown">
                                       <a class="navbar-brand has-sub has-sub3" href="http://localhost:81/CSE485_1851160588_PhanThiQuyen/3.PROJECT/daotao/daotao.php" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ĐÀO TẠO</a>
                                       <div class="dropdown-menu nav-sub nav-sub3" aria-labelledby="dropdownId">
                                           <a class="dropdown-item text-white" href="http://localhost:81/CSE485_1851160588_PhanThiQuyen/3.PROJECT/daotao/daotao.php">Đào tạo đại học</a>
                ...
                <nav class="navbar-mobile fixed-top">
                    ...
                    <ul class="list-nav-mobile">
                        ...
                        <li><a href=""class="nav-link-mobile">ĐÀO TẠO</a>
                            <ul class="list-sub-mobile">
                                <li><a href="http://localhost:81/CSE485_1851160588_PhanThiQuyen/3.PROJECT/daotao/daotao.php"class="sub-link-mobile">Đào tạo đại học</a></li>
                ...
                <div class="container  "  >
                    ...
                    <div class="row content">
                        <div class="col-md-9 logo">
                            <div class="col-md-12">
                                <h3>Giới thiệu Trung tâm tin học</h3>
                               <p>Trung tâm tin học gồm 7 thành viên, nhiệm vụ vận hành hệ thống mạng của trường, phần mềm quản lý hành chính, tham gia công tác giảng dạy cùng các bộ môn trong khoa</p>
                               <p style="padding-top:5%"><b>Danh sách cán bộ Trung tâm.</b></p>
                            </div>
                            <div class="col-md-12">
                                <?php 
                                require("../../config.php");
