...
<html lang="en">
  <head>
    <title>Create Information System</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
      <div class="container " style="justify-content:center;"  >
        <div class="row">
            <div class="col-md-6">
                <h3 style="text-align:center;">THÊM NỘI DUNG HỆ THỐNG THÔNG TIN</h3>
                <form action="process_create_hethongthongtin.php" method="post">
                    <div class="row">
                         <div class="col-md-4">
