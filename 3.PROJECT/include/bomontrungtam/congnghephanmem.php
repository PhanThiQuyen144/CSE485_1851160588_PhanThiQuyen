                ...
                <div class="container  "  >
                    <div class="row ">
                        <div class="col-md-12 gthieu text-white">
                            <h5 >
                                <a href="../../header.php" class="text-white">Bộ môn-Trung tâm</a> > <a href="../bomontrungtam/congnghephanmem.php" class="text-white">CN phần mềm</a> 
                            </h5>
                        </div>
                    </div>
                    <div class="row content">
                        <div class="col-md-9 logo">
                            <div class="col-md-12">
                                <h3><b>Giới thiệu bộ môn Công nghệ phần mềm</b></h3>
                            </div>
                            <div class="col-md-12">
                                <?php 
                                require("../../config.php");
                  ...
                  <div class="footer-conten">
                    <div class="footer-top">
                      <div class="it-nav-footer">
                        ...
                        <ul class="nav-footer-link">
                          <li><a class="ui-link-white" href="http://localhost:81/CSE485_1851160588_PhanThiQuyen/3.PROJECT/include/daotao/daotao.php">Đào tạo</a></li>
                        ...
                        <ul class="nav-footer-link">
                          <li><a class="ui-link-white" href="http://localhost:81/CSE485_1851160588_PhanThiQuyen/3.PROJECT/include/nghiencuukhoahoc/nghien_cuu_khoa_hoc.php">Nghiên cứu khoa học</a></li>
