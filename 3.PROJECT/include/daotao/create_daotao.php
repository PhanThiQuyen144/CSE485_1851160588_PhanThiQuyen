...
<html lang="en">
  ...
  <body>
      <div class="container " style="justify-content:center;"  >
        <div class="row">
            <div class="col-md-6">
                <h3 style="text-align:center;">THÊM CHƯƠNG TRÌNH ĐÀO TẠO</h3>
                <form action="process_create_daotao.php" method="post">
                    <div class="form-group">
                      <label for="">Thêm mới chương trình</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                               ...
                               <a href="index_daotao.php" class="btn btn-primary">Reset</a>
                            </div>
                        </div>
                    </div>
