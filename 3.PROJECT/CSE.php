                    ...
                    <div class="title  ">
                       <nav class="navbar navbar-expand-sm navbar-light navbar1" style=" padding: 0px !important;" >
                           ...
                           <div class="collapse navbar-collapse" id="collapsibleNavId">
                               <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                    <li class="nav-item dropdown ">
                                       <a class="navbar-brand has-sub has-sub2" href="../3.PROJECT/include/nghiencuukhoahoc/nghien_cuu_khoa_hoc.php" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">NGHIÊN CỨU KHOA HỌC</a>
                           ...
                           <div class="collapse navbar-collapse" id="collapsibleNavId">
                               <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                    <li class="nav-item dropdown">
                                       <a class="navbar-brand has-sub has-sub4" href="../3.PROJECT/include/bomontrungtam/giangvien.php" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">BỘ MÔN-TRUNG TÂM</a>
                                       <div class="dropdown-menu nav-sub nav-sub4" aria-labelledby="dropdownId">
                                           <a class="dropdown-item text-white" href="../3.PROJECT/include/bomontrungtam/congnghephanmem.php">CN phần mềm</a>
                                           <a class="dropdown-item text-white" href="../3.PROJECT/include/bomontrungtam/hethongthongtin.php">Hệ thống thông tin</a>
                                           <a class="dropdown-item text-white" href="../3.PROJECT/include/bomontrungtam/khoahocmaytinh.php">Khoa học máy tính</a>
                                           <a class="dropdown-item text-white" href="../3.PROJECT/include/bomontrungtam/tinhocvakythuattinhtoan.php">Kỹ thuật máy tính và mạng</a>
                                           <a class="dropdown-item text-white" href="../3.PROJECT/include/bomontrungtam/toanhoc.php">Toán học</a>
                                           <a class="dropdown-item text-white" href="../3.PROJECT/include/bomontrungtam/trungtamtinhoc.php">
                                            Trung tâm tin học
                                        </a>
                                       </div>
                                   </li>
                           ...
                           <div class="collapse navbar-collapse" id="collapsibleNavId2">
                               <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                                    <li class="nav-item dropdown">
                                       <a class="navbar-brand has-sub has-sub7" href="../3.PROJECT/include/thongbao/thongbao.php" id="dropdownId" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">THÔNG BÁO</a>
                                       <div class="dropdown-menu nav-sub nav-sub7" aria-labelledby="dropdownId">
                                            <a class="dropdown-item text-white" href="../3.PROJECT/include/thongbao/thongbao.php">Thông báo</a>
                    ...
                    <ul class="list-nav-mobile">
                        ...
                        <li><a href=""class="nav-link-mobile">GIỚI THIỆU</a>
                            <ul class="list-sub-mobile">
                                <li><a href="http://cse.tlu.edu.vn/logo-cua-khoa"class="sub-link-mobile">Logo khoa CNTT</a></li>
                                <li><a href="http://cse.tlu.edu.vn/loi-chao-mung"class="sub-link-mobile">Lời chào mừng</a></li>
                                <li><a href="http://cse.tlu.edu.vn/co-cau-to-chuc"class="sub-link-mobile">Tổ chức</a></li>
                                <li><a href="http://cse.tlu.edu.vn/hop-tac-quoc-te"class="sub-link-mobile">Hợp tác liên kết</a></li>
                              </ul></li>
                    ...
                    <div class="footer-top">
                      <div class="it-nav-footer">
                        <ul class="nav-footer-link">
                          <li><a class="ui-link-white" href="../3.PROJECT/include/gioithieu/gioithieu.php">Giới thiệu</a></li>
                          <li><a class="ui-link-white" href="../3.PROJECT/include/gioithieu/logokhoa.php">Logo của Khoa CNTT</a></li>
                          <li><a class="ui-link-white" href="../3.PROJECT/include/gioithieu/loichaomung.php">Lời chào mừng</a></li>
                          <li><a class="ui-link-white" href="../3.PROJECT/include/gioithieu/cocautochuc.php">Tổ chức</a></li>
