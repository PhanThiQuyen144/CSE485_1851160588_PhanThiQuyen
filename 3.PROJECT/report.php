							...
							<td width="70"> Xóa </td>							
                             ...
                             <?php 
                                ...
                                <tr>
							        ...
							        <td> cse1 </td>
							        <td><a href="index_cse1.php"><i class="fa fa-street-view" aria-hidden="true"></i>Xem</a></td>
							        <td><a href="delete_cse1.php"> <i class="fas fa-calendar-plus"></i>Thêm </a></td>
							         <td><a href="index_cse1.php"><i class="far fa-edit"></i> Sửa</a></td>
							        <td><a href="index_cse1.php"><i class="fas fa-trash-alt"></i>Xóa </a></td>
                                </tr>
                                 <tr>
                                    <td><?php echo $row['username'] ?> </td>
							        <td> cse2 </td>
